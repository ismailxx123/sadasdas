...
exports.run = (client, message, args) => {
    const embed = new Discord.RichEmbed()
        ...
        .setDescription(`:white_small_square:**Botun Davet Linki İçin** [TIKLA](https://discord.com/oauth2/authorize?client_id=773491755215224862&scope=bot&permissions=805314622) \n:white_small_square:**Destek Sunucusu İçin** [TIKLA](https://discord.gg/dK32PV)`)
